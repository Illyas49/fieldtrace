...
export default function ResearchFocus() {
  ...
  return (
    <section id="research-focus" className="py-24 bg-gradient-to-b from-white via-mustard-50 to-white relative overflow-hidden">
      <div className="absolute inset-0 bg-grid-pattern opacity-5"></div>
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full h-64 bg-gradient-to-t from-mustard-100/50 to-transparent"></div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {focuses.map((focus, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-white p-7 rounded-xl border-2 border-gray-200 hover:border-mustard-500 shadow-md hover:shadow-2xl transition-all duration-300 group hover:-translate-y-2"
                >
                  <div className="w-14 h-14 bg-gradient-to-br from-mustard-500 to-mustard-600 rounded-xl flex items-center justify-center mb-5 group-hover:scale-110 transition-transform shadow-lg">
